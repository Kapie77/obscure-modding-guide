...
- [zwoBlender](https://github.com/Al-Hydra/zwoBlender) - A Blender extension for importing and exporting models from Obscure 1 and 2, including characters, weapons, maps, and more.
...
- [Obscure 010 Editor Templates](https://github.com/Al-Hydra/HydraVision-Obscure-010-Editor-Templates) - 010 Editor templates for Obscure 1 and 2 files.
