...
# Textures (.dic/.dip)
- [Obscure Textures Tool](https://github.com/Al-Hydra/zwoBlender/blob/main/zwoLib/texDict.py) - A tool for extracting and repacking textures from Obscure 1 and 2. It does not yet support the Wii or hvt.
